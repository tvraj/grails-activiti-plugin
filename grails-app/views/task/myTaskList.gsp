...
<html>
    <head>
        ...
        <title><g:message code="myTasks.title" default="My Tasks of {0}" args="[session.username]"/></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="myTasks.title" default="My Tasks of {0}" args="[session.username]"/></h1>
